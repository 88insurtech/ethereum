 ...
 **/
contract SmartProtectionPolicyBeta {
    ...
    constructor () public {
        ...
        policy = Policy({
            startPolicyTime : now,
            policyNumber : "1",
            valueOfProperty : 3000,
            insuredItem : "Samsung S8",
            customerName : "Alex Braz",
            customer : 0xCf0F482F2C1eF1f221f09e3Cf14122fcE0424F94,
            premium : 100,
            deductablePaymentValue : 10,
            contractDuration : 365 days,
            policyBalanceValue : 0
        });

        agent = 0xCf0F482F2C1eF1f221f09e3Cf14122fcE0424F94;
        broker = 0xCf0F482F2C1eF1f221f09e3Cf14122fcE0424F94;
        donationsSocialDestiny = 0xCf0F482F2C1eF1f221f09e3Cf14122fcE0424F94;

        emit ChangeStatus(defaultStatus, 0);
    }
